...
run = wandb.init(
    ...
    name = "1 GPU A100 10CHA 32CNN SGD STEP5",
    #resume = True,
...
for epoch in range(50):
    ...
    checkpoint(model, optimizer, f"checkpointmaglarge257_SGD_5STEP.pth", epoch, running_loss / len(train_loader))
...
model_path = 'AudioMaskerCircular-MAG257_SGD_5STEP.pth'
