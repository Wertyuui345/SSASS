...
class BeamSep(nn.Module):
    def __init__(self):
        ...
        self.conv1=ConvLayer(30, 32) #8 input channels(change to # of beamspace input channels) Should be 15? I believe
        ...
        self.final1=FullCon(4096, 256) #Change 2048, to appropriate out size
