...
run = wandb.init(
    ...
    name = "1 GPU A100 10CHA 32CNN 5STEP",
    #resume = True,
...
for epoch in range(50):
    ...
    checkpoint(model, optimizer, f"checkpointmaglarge257_5step.pth", epoch, running_loss / len(train_loader))
...
model_path = 'AudioMaskerCircular-MAG257_5STEP.pth'
