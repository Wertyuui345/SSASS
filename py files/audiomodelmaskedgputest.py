...
for epoch in range(200):
    ...
    if rank == 0:
        ...
        checkpoint(ddp_model, optimizer, f"checkpoint1ActualFULL.pth", epoch, running_loss / len(train_loader))
...
if rank == 0:
    model_path = 'AudioMaskerCircular1Actual-SmallFULL.pth'
