...
run = wandb.init(
    ...
    name = "1 GPU A100 10CHA 32CNN HIGAMMA.9",
    #resume = True,
...
checkload = torch.load('AudioMaskerCircular-MAG257_5STEP.pth')
...
for epoch in range(50):
    ...
    checkpoint(model, optimizer, f"checkpointmaglarge257_higamma.pth", epoch, running_loss / len(train_loader))
...
model_path = 'AudioMaskerCircular-MAG257_HIGAMMA.9.pth'
