...
run = wandb.init(
    ...
    name = "1 GPU A100 10CHA 32CNN DEEP HIGAMMA.9",
    #resume = True,
...
class BeamSep(nn.Module):
    def __init__(self):
        ...
        self.pool=nn.AvgPool2d((1,32)) #average along time axis (38)
...
for epoch in range(100):
    ...
    checkpoint(model, optimizer, f"checkpointmaglarge257_deep.pth", epoch, running_loss / len(train_loader))
...
model_path = 'AudioMaskerCircular-MAG257_DEEP.pth'
